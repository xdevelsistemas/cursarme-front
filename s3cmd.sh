...
aws s3 sync dist/public/assets/xduka s3://static.beta.cursar.me/assets/xduka  --acl=public-read --delete --cache-control="max-age=86400"
aws s3 sync dist/public/html s3://static.beta.cursar.me/html  --acl=public-read --delete --cache-control="max-age=86400"
