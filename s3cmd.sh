#!/bin/bash
#compress
aws s3 sync xduka-ui/dist/public/assets/html s3://static.beta.cursar.me/assets/html  --acl=public-read --delete --cache-control="max-age=86400" --content-encoding="gzip"
...
aws s3 sync xduka-ui/dist/public/assets/js s3://static.beta.cursar.me/assets/js  --acl=public-read --delete --cache-control="max-age=86400" --content-encoding="gzip"
#not compress
