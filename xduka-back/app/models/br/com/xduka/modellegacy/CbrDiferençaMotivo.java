 ...
 */
@Entity
@IdClass(CbrDiferençaMotivoPK.class)
public class CbrDiferençaMotivo {
    ...
    private List<CbrDiferença> cbrDiferenças;
    ...
    public boolean equals(Object o) {
        ...
        CbrDiferençaMotivo that = (CbrDiferençaMotivo) o;
    ...
    @OneToMany(mappedBy = "cbrDiferençaMotivo")
    ...
    @OneToMany(mappedBy = "cbrDiferençaMotivo")
    public List<CbrDiferença> getCbrDiferenças() {
        return cbrDiferenças;
    }

    public void setCbrDiferenças(List<CbrDiferença> cbrDiferenças) {
        this.cbrDiferenças = cbrDiferenças;
    }
}
