 ...
 */
@Entity
@IdClass(CbrDiferençaPK.class)
public class CbrDiferença {
    ...
    private List<CbrDiferençaMês> cbrDiferençaMêses;
    ...
    public boolean equals(Object o) {
        ...
        CbrDiferença that = (CbrDiferença) o;
    ...
    @OneToMany(mappedBy = "cbrDiferença")
    public List<CbrDiferençaMês> getCbrDiferençaMêses() {
        return cbrDiferençaMêses;
    }

    public void setCbrDiferençaMêses(List<CbrDiferençaMês> cbrDiferençaMêses) {
