 ...
 */
@Entity
@IdClass(AcdPeriodoPK.class)
public class AcdPeriodo {
    ...
    public AcdNivel getAcdNivel() {
        return acdNivel;
    }

    public void setAcdNivel(AcdNivel acdNivel) {
        this.acdNivel = acdNivel;
    }

    @OneToMany(mappedBy = "acdPeriodo")
