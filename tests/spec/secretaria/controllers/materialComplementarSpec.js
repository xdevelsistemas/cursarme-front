(function() {
    ...
    describe('Controller: materialComplementar test', function() {
        ...
        beforeEach(function() {
            ...
            inject(function($injector, _$controller_, _$httpBackend_) {
                ...
                $httpBackend.when('GET','/api/secretaria/dados-material-complementar').respond(200, dadosCursos);
                $httpBackend.when('GET','/api/secretaria/template-material-complementar').respond(200, template);

                // Definindo controller
                vm = _$controller_('materialComplementar', {"$scope": $scope});
            });
        });


        describe('-> Definição do materialComplementar', function() {
            it('-> materialComplementar definido', function () {
        ...
        describe('-> Definindo cadastro', function() {
            ...
            // Preenchendo o restante dos campos
                ...
                vm._model.texto.model.val = "Teste unitário - materialComplementar";
